...
// cria ED, copia a chave primária e as chaves secundárias de A1 para A2
void A2(FILE *in) {
...
// decompõe A2 em vários A3 (um pra cada chave secundária). nesse caso vai ser igual ao A2
void A3(FILE *in) {
...
void A4(FILE *in) {
    ...
    Cliente *c;
    while ((c = carregaCliente(in)) != NULL) {
        clientes[numClientes++] = c; // adiciona o cliente ao vetor para ordenação
        // imprimeCliente(c);
    }
